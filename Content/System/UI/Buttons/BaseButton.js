...
export class BaseButton {
    constructor(positionX, positionY, texturePath = null) {
        ...
        // Estado e cooldown individuais para cada botão
        this.isTouched = false;
        this.touchCooldownFrames = 0;
        this.cooldownLimit = 15; // Duração do cooldown em frames
    ...
    checkInteraction() {
        ...
        if (this.isHovered && isMouseDown) {
            // Verifica o cooldown próprio deste botão
    ...
    Update() {
        ...
        this.processCooldown(); // Avança o cooldown individual deste botão a cada frame
    }
