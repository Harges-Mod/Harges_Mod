export class HargesMModeUpdate extends ModPlayer {
    constructor() {
        super();
        
        this.hargesPlayer = ModPlayer.Get('HargesMMode')
    ...
    if (Rand.NextBool(2)) {
        Harges.Graphics.UParticle.Spawn(
            Harges.Assets.Loader.Load("Assets/Adittive/dust.png"),
            Vector2.new(player.Center.X, npc.Center.Y - 120),
            Vecto2.new(0, 2),
            {
                life: Generic.toSec(3),
                scaleTo: Vector2.new(1.2, 1.2),
                scaleFrom: Vector2.new(1.2, 1.2),
