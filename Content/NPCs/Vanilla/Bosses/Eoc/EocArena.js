...
export class EocArena extends ModProjectile {
    ...
    AI(proj) {
        ...
        let normalScale = ai[0] === 1 ? 5.5 : 4.5;
        ...
        if (this.ArenaAsset) {
            let arenaRadius = (this.ArenaAsset.Width / 2) * averageScale * 2;
    ...
    PreDraw(proj, lightColor) {
        ...
        // Oscilação dinâmica no canal Vermelho
        let baseR = Color.Purple.R
        let baseG = Color.Purple.G
        let baseB = Color.Purple.B
        ...
        for (let i = this.oldPos.length - 1; i >= 0; i--) {
            ...
            let trailColor = Color.new(trailR, baseG, baseB, 0);
        ...
        let rgbColor = Color.new(baseR, baseG, baseB, 0);
