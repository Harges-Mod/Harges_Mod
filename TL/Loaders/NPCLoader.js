...
export class NPCLoader {
    ...
    static UpdateCamera(npc) {
            for (const gNpc of GlobalNPC.RegisteredNPCs) {
            gNpc?.UpdateCamera(npc);
        }
    ...
    static EditSpawnRate(player, spawnRate, maxSpawns) {
        for (const gNpc of GlobalNPC.RegisteredNPCs) {
            gNpc?.EditSpawnRate(player, spawnRate, maxSpawns);
        }
    }
